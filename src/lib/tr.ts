...
/** İyelik ekiyle biten birleşik adlar: ekten önce "n" alır (Beylikdüzü'nde) */
const possessiveCompound = ["Beylikdüzü"];

/** Kadıköy'de, Tuzla'da, Beşiktaş'ta, Beylikdüzü'nde */
export const de = (w: string) => `${w}'${possessiveCompound.includes(w) ? "n" : ""}${endsHard(w) ? "t" : "d"}${isBack(w) ? "a" : "e"}`;
